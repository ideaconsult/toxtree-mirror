...
public class SA27_genTest extends TestMutantRules {
    ...
    public void test_ortho_disubstitution() throws Exception {
    	...
    	Object[][] smiles = {
    			...
    			{"[H]OC([H])([H])C([H])([H])N(C=1C([H])=C([H])C(=C(C=1([H]))[N+](=O)[O-])N([H])C([H])([H])[H])C([H])([H])C([H])([H])O[H]",yes},
    			...
    			{"[H]C1=C([H])C(=C(C(=C1([H]))C([H])([H])[H])[N+](=O)[O-])C([H])([H])[H]",no},
    			{"O=[N+]([O-])C2=C3C=CC=CC3(=CC=1C=CC=CC=12)",yes},
    			{"[H]C=1C([H])=C([H])C=3C(C=1([H]))=C([H])C=2C([H])=C([H])C([H])=C([H])C=2C=3[N+](=O)[O-]",yes}
