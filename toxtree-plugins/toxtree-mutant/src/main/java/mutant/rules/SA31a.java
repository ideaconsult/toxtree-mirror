...
This imply that if in the same molecule there is a diphenyl or a biphenyl and a halogenated benzene, the latter will not be detected. 
    ...
    public static Object[][] exclusion_rules = {
        ...
        {"Nitro aromatic","c[N+](=O)[O-]","O=[N+]([O-])C=1C=CC=C(C=1)Cl","SA27",new Boolean(false)},
        {"Primary aromatic amine","c[N]([#1,C])([#1,C])","CNC=1C([H])=C([H])C([H])=C(Cl)C=1([H])","SA28",new Boolean(false)},
        {"Hydroxyl amine","cN([OX2H])([#1,C])","[H]ONC1=CC=CC=C1Cl","SA28",new Boolean(false)},
        {"Hydroxyl amine ester","cN([#1,C])OC=O","CCCN(OC=O)C1=CC=CC=C1(Cl)","SA28",new Boolean(false)},
        {"Aromatic mono- and dialkylamine","c[NX3v3]([#1,CH3])([#1,CH3])","CNC=1C=CC=C(Cl)C=1","SA28bis",new Boolean(false)},        
        ...
        {"Aromatic N-acyl amine","cNC(=O)[#1,CH3]","CC(=O)NC=1C=CC=C(C=1)Cl","SA28ter",new Boolean(false)},
        {"Aromatic diazo","cN=[N]a","C1=CC=C(C=C1)N=NC=2C=CC=C(C=2)Cl","SA29",new Boolean(false)},
