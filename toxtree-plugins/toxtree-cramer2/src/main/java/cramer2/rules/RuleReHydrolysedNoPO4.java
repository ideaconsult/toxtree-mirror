...
public class RuleReHydrolysedNoPO4 extends RuleReadilyHydrolised {
	 ...
	 *
	 */
	public RuleReHydrolysedNoPO4() {
		super();
		id = "41";
		title = "Removes phosphates";
		explanation.append("<html>All phosphate groups that can occur natural compounds are hydrolysed and removed.</html>");
		examples[0] = "COPOC";
	...
	public boolean verifyRule(IAtomContainer  mol) throws DecisionMethodException {
        ...
        //TODO //remove PO4 make different reaction! mf.X() ?
