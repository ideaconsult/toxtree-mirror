...
public class RuleAminoAcids extends RuleSMARTSubstructure 
{
    ...
    public RuleAminoAcids() 
    {
        ...
        try 
        {
            ...
            super.addSubstructure( "2", "[$([$([NX3H2,NX4H3+]),$([NX3H](C)(C))][CX4H2][CX3](=[OX1])[OX2H,OX1-,N])]", false );
            super.setContainsAllSubstructures( false );
            super.setExplanation( 
                "Checks for amino acids. " +
                "Amino acids are associated with easy biodegradability." 
            );
            id = "30";
            title = "Amino acids";
            examples[ 0 ] = "CC1OC1CC";
