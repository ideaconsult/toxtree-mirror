 ...
 * @version $Id: CategoryBiodegradable.java 936 2008-12-04 17:43:31Z joerg $
 * @author <a href="mailto:info@molecular-networks.com">Molecular Networks</a>
 * @author $Author: joerg $
 */
public class CategoryBiodegradable extends DefaultCategory 
{
    ...
    {
        super( "Class 1 (easily biodegradable chemical)", 1 );
        setExplanation( 
