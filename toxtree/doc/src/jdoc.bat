...
rem javadoc -classpath C:\j2sdk1.4.2_06\lib\tools.jar  -doclet ListFilesDoclet -docletpath d:\src\ambit\src\ambit\doc -sourcepath d:\src\ambit\src -package ambit -subpackages data domain
