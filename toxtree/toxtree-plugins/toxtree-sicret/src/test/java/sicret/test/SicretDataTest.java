...
public class SicretDataTest extends TestCase {
	...
	public static void main(String[] args) {
		junit.textui.TestRunner.run(SicretDataTest.class);
	}
	 ...
	 * @param arg0
	 */
	public SicretDataTest(String arg0) {
		super(arg0);
		try {
			cr = new SicretRules();
	...
	protected  IDecisionResult classify(String smiles,String id,SicretRules rules){
	...
	protected  IDecisionResult classify(String smiles,String id,SicretRules rules,String MeltingPoint,String LogKow,String LipidSolubility,String MoleculWeight,String SurfaceTension,String VapourPressure,String AqueousSolubility){
		IDecisionResult result = rules.createDecisionResult();
