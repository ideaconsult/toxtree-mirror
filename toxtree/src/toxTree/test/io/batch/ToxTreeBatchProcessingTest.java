 ...
 */
public class ToxTreeBatchProcessingTest extends TestCase {
	...
	public static void main(String[] args) {
		junit.textui.TestRunner.run(ToxTreeBatchProcessingTest.class);
	}
	...
	*/
	...
	public void testBatchFromConfig() throws Exception {
			...
			assertNotNull(bp.getDecisionMethod());
//			bp.setDecisionMethod(new CramerRules());			
			...
			assertEquals(12,bp.getReadRecordsCount());
			assertEquals(12,bp.getWrittenRecordsCount());
	...
	public void testInterruptedJob() throws Exception  {
			...
			batch.start();
			assertEquals(12,batch.getReadRecordsCount());
...
//------------------			
			...
			assertEquals(BatchProcessing.STATUS_PAUSED,bp.getStatus());
			
			assertEquals(21,bp.getReadRecordsCount());
			assertEquals(21,bp.getWrittenRecordsCount());		
