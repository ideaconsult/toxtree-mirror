...
public class FunctionalGroups {
    ...
    public static QueryAtomContainer methyl() {
        ...
        SymbolQueryAtom h1 = new SymbolQueryAtom(DefaultChemObjectBuilder.getInstance().newAtom(Elements.HYDROGEN));
        SymbolQueryAtom h2 = new SymbolQueryAtom(DefaultChemObjectBuilder.getInstance().newAtom(Elements.HYDROGEN));
        SymbolQueryAtom h3 = new SymbolQueryAtom(DefaultChemObjectBuilder.getInstance().newAtom(Elements.HYDROGEN));        
        query.addAtom(c);
        query.addAtom(h1);
        query.addAtom(h2);        
        query.addAtom(h3);        
    ...
    public static QueryAtomContainer noxide_aromatic() {
        ...
        n.setCharge(1.0);
        TopologySymbolQueryAtom o = new TopologySymbolQueryAtom(DefaultChemObjectBuilder.getInstance().newAtom(Elements.OXYGEN),false);
        o.setCharge(-1.0);
        query.addAtom(o);
        query.addAtom(n);
    ...
    public static QueryAtomContainer hydroxy_ring() {
        QueryAtomContainer query = new QueryAtomContainer();
        query.setID(HYDROXY);
        TopologySymbolQueryAtom c = new TopologySymbolQueryAtom(DefaultChemObjectBuilder.getInstance().newAtom(Elements.CARBON),true);
    ...
    public static QueryAtomContainer hydroxy1() {
        ...
        //old - fails to match safrole TopologySymbolQueryAtom(DefaultChemObjectBuilder.getInstance().newAtom(Elements.CARBON),false); 
        c.setProperty(DONTMARK,query.getID());
        SymbolQueryAtom o = new SymbolQueryAtom(DefaultChemObjectBuilder.getInstance().newAtom(Elements.OXYGEN));
        SymbolQueryAtom h = new SymbolQueryAtom(DefaultChemObjectBuilder.getInstance().newAtom(Elements.HYDROGEN));
        query.addAtom(h);
    ...
    public static QueryAtomContainer hydroxyEsterSubstituted() {
        ...
        SymbolQueryAtom c1 = new SymbolQueryAtom(DefaultChemObjectBuilder.getInstance().newAtom(Elements.CARBON)); 
        SymbolQueryAtom c2 = new SymbolQueryAtom(DefaultChemObjectBuilder.getInstance().newAtom(Elements.CARBON));
        SymbolQueryAtom o = new SymbolQueryAtom(DefaultChemObjectBuilder.getInstance().newAtom(Elements.OXYGEN));
        SymbolQueryAtom o2 = new SymbolQueryAtom(DefaultChemObjectBuilder.getInstance().newAtom(Elements.OXYGEN));
        SymbolQueryAtom r = new SymbolQueryAtom(DefaultChemObjectBuilder.getInstance().newAtom(Elements.HYDROGEN));
        query.addAtom(r);
    ...
    public static QueryAtomContainer primaryAmine(boolean aliphatic) {
        ...
        IQueryAtom r;
        if (aliphatic) r= new TopologySymbolQueryAtom(DefaultChemObjectBuilder.getInstance().newAtom(Elements.CARBON),false); 
        else r = new SymbolQueryAtom(DefaultChemObjectBuilder.getInstance().newAtom(Elements.CARBON));
    ...
    public static QueryAtomContainer secondaryAmine(boolean aliphatic) {
        ...
        IAtom a  = DefaultChemObjectBuilder.getInstance().newAtom(Elements.NITROGEN);
        a.setFormalCharge(0);
        SymbolAndChargeQueryAtom n = new SymbolAndChargeQueryAtom(a);
        SymbolQueryAtom h = new SymbolQueryAtom(DefaultChemObjectBuilder.getInstance().newAtom(Elements.HYDROGEN));
        
        for (int i=0; i<2; i++) {
	        //if (aliphatic) c[i]= new TopologySymbolQueryAtom(DefaultChemObjectBuilder.getInstance().newAtom(Elements.CARBON),false); 
	        //else 
        	if (aliphatic)
        		c[i] = new CHQueryAtom(DefaultChemObjectBuilder.getInstance().newAtom(Elements.CARBON));
        	else c[i]= new SymbolQueryAtom(DefaultChemObjectBuilder.getInstance().newAtom(Elements.CARBON));
	        query.addAtom(c[i]);
	        if (aliphatic)
    ...
    */
    ...
    public static QueryAtomContainer hydrochlorideOfAmine(int amine) {
        ...
        IAtom chlor = DefaultChemObjectBuilder.getInstance().newAtom(Elements.CHLORINE);
        ...
        for (int i=0; i < 4; i++) {
        	...
        	if ((i+1) > amine) r[i] = new SymbolQueryAtom(DefaultChemObjectBuilder.getInstance().newAtom(Elements.HYDROGEN));
        	else r[i] = new SymbolQueryAtom(DefaultChemObjectBuilder.getInstance().newAtom(Elements.CARBON));
        	query.addAtom(r[i]);
    ...
    public static QueryAtomContainer hydrochlorideOfAmine3() {
        ...
        for (int i=0; i < 3; i++) {
        	...
        	r[i] = new SymbolQueryAtom(DefaultChemObjectBuilder.getInstance().newAtom(Elements.CARBON));
        	query.addAtom(r[i]);
        	if (i==0)
    ...
    public static QueryAtomContainer sulphateOfAmine(int amine) {
        ...
        SymbolQueryAtom s = new SymbolQueryAtom(DefaultChemObjectBuilder.getInstance().newAtom(Elements.SULFUR));
        query.addAtom(s);        
        IQueryAtom[] o = new IQueryAtom[4];
        for (int i=0; i < 4; i++) {
        	if (i==0) {
        		IAtom a = DefaultChemObjectBuilder.getInstance().newAtom(Elements.OXYGEN);
        		a.setFormalCharge(-1);
        		o[i] = new SymbolAndChargeQueryAtom(a);
        	} else	o[i] = new SymbolQueryAtom(DefaultChemObjectBuilder.getInstance().newAtom(Elements.OXYGEN));
    ...
    public static QueryAtomContainer nitro2double() {
        ...
        r.addSymbol("H");
        SymbolQueryAtom n = new SymbolQueryAtom(DefaultChemObjectBuilder.getInstance().newAtom(Elements.NITROGEN));
        SymbolQueryAtom o1 = new SymbolQueryAtom(DefaultChemObjectBuilder.getInstance().newAtom(Elements.OXYGEN));
        SymbolQueryAtom o2 = new SymbolQueryAtom(DefaultChemObjectBuilder.getInstance().newAtom(Elements.OXYGEN));        
    ...
    public static QueryAtomContainer nitro1double() {
        ...
        r.addSymbol("H");
        IAtom a = DefaultChemObjectBuilder.getInstance().newAtom(Elements.NITROGEN);      a.setFormalCharge(+1);
        SymbolAndChargeQueryAtom n = new SymbolAndChargeQueryAtom(a);
        
        SymbolQueryAtom o1 = new SymbolQueryAtom(DefaultChemObjectBuilder.getInstance().newAtom(Elements.OXYGEN));
        
        IAtom o = DefaultChemObjectBuilder.getInstance().newAtom(Elements.OXYGEN);      o.setFormalCharge(-1);
    ...
    public static QueryAtomContainer Nnitroso() {
        ...
        r2.addSymbol("H");
        SymbolQueryAtom n1 = new SymbolQueryAtom(DefaultChemObjectBuilder.getInstance().newAtom(Elements.NITROGEN));
        SymbolQueryAtom n2 = new SymbolQueryAtom(DefaultChemObjectBuilder.getInstance().newAtom(Elements.NITROGEN));
        SymbolQueryAtom o = new SymbolQueryAtom(DefaultChemObjectBuilder.getInstance().newAtom(Elements.OXYGEN));
    ...
    public static QueryAtomContainer triAzeno() {
        ...
        query.setID(TRIAZENO);
     	...
     	SymbolQueryAtom r = new SymbolQueryAtom(DefaultChemObjectBuilder.getInstance().newAtom(Elements.CARBON));
     	r.setProperty(DONTMARK,query.getID());
        SymbolQueryAtom n1 = new SymbolQueryAtom(DefaultChemObjectBuilder.getInstance().newAtom(Elements.NITROGEN));
        SymbolQueryAtom n2 = new SymbolQueryAtom(DefaultChemObjectBuilder.getInstance().newAtom(Elements.NITROGEN));
        SymbolQueryAtom n3 = new SymbolQueryAtom(DefaultChemObjectBuilder.getInstance().newAtom(Elements.NITROGEN));
        SymbolQueryAtom h1 = new SymbolQueryAtom(DefaultChemObjectBuilder.getInstance().newAtom(Elements.HYDROGEN));
        SymbolQueryAtom h2 = new SymbolQueryAtom(DefaultChemObjectBuilder.getInstance().newAtom(Elements.HYDROGEN));
    ...
    public static QueryAtomContainer acyclic_acetal() {
        ...
        for (int i =0; i < 3; i++) {
            c[i] = new SymbolQueryAtom(DefaultChemObjectBuilder.getInstance().newAtom(Elements.CARBON));
            query.addAtom(c[i]);
        }
        SymbolQueryAtom[] o = new SymbolQueryAtom[2];
        for (int i =0; i < 2; i++) {
            o[i] = new SymbolQueryAtom(DefaultChemObjectBuilder.getInstance().newAtom(Elements.OXYGEN));
            query.addAtom(o[i]);
        }
    ...
    public static QueryAtomContainer ether() {
        ...
        for (int i =0; i < 2; i++) {
            r[i] = new CHQueryAtom(DefaultChemObjectBuilder.getInstance().newAtom(Elements.CARBON));
//            r[i].setProperty(DONTMARK,query.getID());            
            query.addAtom(r[i]);
        }
        //TotalValencyAtom s = new TotalValencyAtom(2);
        SymbolQueryAtom s = new SymbolQueryAtom(DefaultChemObjectBuilder.getInstance().newAtom(Elements.OXYGEN));
        query.addAtom(s);
    ...
    public static QueryAtomContainer methylether() {
        ...
        for (int i =0; i < 3; i++) {
            h[i] = new SymbolQueryAtom(DefaultChemObjectBuilder.getInstance().newAtom(Elements.HYDROGEN));
            query.addAtom(h[i]);
    ...
    public static QueryAtomContainer carbonate() {
        ...
        SymbolQueryAtom o1 = new SymbolQueryAtom(DefaultChemObjectBuilder.getInstance().newAtom(Elements.OXYGEN));
        SymbolQueryAtom o2 = new SymbolQueryAtom(DefaultChemObjectBuilder.getInstance().newAtom(Elements.OXYGEN));
        SymbolQueryAtom o3 = new SymbolQueryAtom(DefaultChemObjectBuilder.getInstance().newAtom(Elements.OXYGEN));        
        query.addAtom(r); query.addAtom(e); query.addAtom(c);
    ...
    public static QueryAtomContainer anhydride() {
        ...
        SymbolQueryAtom e = new SymbolQueryAtom(DefaultChemObjectBuilder.getInstance().newAtom(Elements.CARBON));
        r.setProperty(DONTMARK,query.getID());
    ...
    public static QueryAtomContainer lactone(boolean abUnsaturated) {
        ...
        if (abUnsaturated) {
            SymbolQueryAtom ab = new SymbolQueryAtom(DefaultChemObjectBuilder.getInstance().newAtom(Elements.CARBON));
    ...
    public static QueryAtomContainer ketone_ring() {
        ...
        SymbolQueryAtom[] c = new SymbolQueryAtom[3];
        for (int i =0; i < 3; i++) {
       		c[i] = new TopologySymbolQueryAtom(DefaultChemObjectBuilder.getInstance().newAtom(Elements.CARBON),true);   
            query.addAtom(c[i]);
        }
    ...
    public static QueryAtomContainer sidechain_ketone() {
        ...
        for (int i =0; i < 3; i++) {
        	if (i==1)
        		c[i] = new TopologySymbolQueryAtom(DefaultChemObjectBuilder.getInstance().newAtom(Elements.CARBON),false);
        	else
        		c[i] = new SymbolQueryAtom(DefaultChemObjectBuilder.getInstance().newAtom(Elements.CARBON));   
            query.addAtom(c[i]);
        }
        
        SymbolQueryAtom o = new TopologySymbolQueryAtom(DefaultChemObjectBuilder.getInstance().newAtom(Elements.OXYGEN),false);
        query.addAtom(o);
        query.addBond(new OrderQueryBond(c[0], c[1], CDKConstants.BONDORDER_SINGLE));
    ...
    public static QueryAtomContainer alcohol(boolean aliphatic) {
        ...
        CHQueryAtom r;
        if (aliphatic) { 
            r= new AliphaticCHQueryAtom(DefaultChemObjectBuilder.getInstance().newAtom(Elements.CARBON));
        	query.addAtom(r);
        } else { 
        	r = new CHQueryAtom(DefaultChemObjectBuilder.getInstance().newAtom(Elements.CARBON));
    ...
    public static QueryAtomContainer sulphamate(String[] metals) {
    	...
    	for (int i= 0; i<(atoms.length-1);i++) {
    		a[i] = new SymbolQueryAtom(DefaultChemObjectBuilder.getInstance().newAtom(atoms[i]));
    		q.addAtom(a[i]);
    	}
    ...
    public static QueryAtomContainer sulphate(String[] setOfAtoms) {
        ...
        SymbolQueryAtom o2 = new SymbolQueryAtom(DefaultChemObjectBuilder.getInstance().newAtom(Elements.OXYGEN));
        SymbolQueryAtom o3 = new SymbolQueryAtom(DefaultChemObjectBuilder.getInstance().newAtom(Elements.OXYGEN));
        SymbolQueryAtom o4 = new SymbolQueryAtom(DefaultChemObjectBuilder.getInstance().newAtom(Elements.OXYGEN));          
    ...
    public static QueryAtomContainer polyoxyethylene(int n) {
        ...
        for (int i = 0; i < n; i++) {
            o = new SymbolQueryAtom(DefaultChemObjectBuilder.getInstance().newAtom(Elements.OXYGEN)); query.addAtom(o);
            if (i>0)
            ...
            for (int j=0; j < 2; j++) { 
                c[j] = new SymbolQueryAtom(DefaultChemObjectBuilder.getInstance().newAtom(Elements.CARBON)); query.addAtom(c[j]);
                for (int j1=0; j1 < 2; j1++) { 
                    h[j*2+j1] = new SymbolQueryAtom(DefaultChemObjectBuilder.getInstance().newAtom(Elements.HYDROGEN)); 
    ...
    */
    ...
    public static QueryAtomContainer vicinalDiKetone() {
    	//TODO "[*]C(=O)C(=O)[*]"
    	  ...
    	  SymbolQueryAtom a1 = new SymbolQueryAtom(DefaultChemObjectBuilder.getInstance().newAtom(Elements.OXYGEN));
    	  q.addAtom(a1);
    	  SymbolQueryAtom a2 = new SymbolQueryAtom(DefaultChemObjectBuilder.getInstance().newAtom(Elements.CARBON));
    	  q.addAtom(a2);
    	  InverseSymbolSetQueryAtom a3 = new InverseSymbolSetQueryAtom();
    	  a3.addSymbol("O"); a3.addSymbol("S"); q.addAtom(a3);
    	  SymbolQueryAtom a4 = new SymbolQueryAtom(DefaultChemObjectBuilder.getInstance().newAtom(Elements.CARBON));
    	  q.addAtom(a4);
    	  SymbolQueryAtom a5 = new SymbolQueryAtom(DefaultChemObjectBuilder.getInstance().newAtom(Elements.OXYGEN));
    	  q.addAtom(a5);
    ...
    public static QueryAtomContainer ketoneAttachedToTerminalVinyl() {
    	  ...
    	  SymbolQueryAtom o = new SymbolQueryAtom(DefaultChemObjectBuilder.getInstance().newAtom(Elements.OXYGEN));
    	  mol.addAtom(o);
    	  SymbolQueryAtom c3 = new SymbolQueryAtom(DefaultChemObjectBuilder.getInstance().newAtom(Elements.CARBON));
    	  mol.addAtom(c3);
    	  SymbolQueryAtom h1 = new SymbolQueryAtom(DefaultChemObjectBuilder.getInstance().newAtom(Elements.HYDROGEN));
    	  mol.addAtom(h1);
    	  SymbolQueryAtom h2 = new SymbolQueryAtom(DefaultChemObjectBuilder.getInstance().newAtom(Elements.HYDROGEN));
    ...
    public static QueryAtomContainer ketalAttachedToTerminalVinyl() {
    	//TODO "[*]C(O)(O)C=C"
    	  ...
    	  r3.addSymbol("O");   r3.addSymbol("H");   mol.addAtom(r3);
    	    ...
    	    SymbolQueryAtom a1 = new SymbolQueryAtom(DefaultChemObjectBuilder.getInstance().newAtom(Elements.CARBON));
    	    mol.addAtom(a1);
    	    SymbolQueryAtom a3 = new SymbolQueryAtom(DefaultChemObjectBuilder.getInstance().newAtom(Elements.CARBON));
    	    mol.addAtom(a3);
    	    SymbolQueryAtom a4 = new SymbolQueryAtom(DefaultChemObjectBuilder.getInstance().newAtom(Elements.OXYGEN));
    	    mol.addAtom(a4);
    	    SymbolQueryAtom a5 = new SymbolQueryAtom(DefaultChemObjectBuilder.getInstance().newAtom(Elements.OXYGEN));
    	    mol.addAtom(a5);
    	    SymbolQueryAtom a6 = new SymbolQueryAtom(DefaultChemObjectBuilder.getInstance().newAtom(Elements.CARBON));
    	    mol.addAtom(a6);
    	    SymbolQueryAtom a9 = new SymbolQueryAtom(DefaultChemObjectBuilder.getInstance().newAtom(Elements.HYDROGEN));
    	    mol.addAtom(a9);
    	    SymbolQueryAtom a10 = new SymbolQueryAtom(DefaultChemObjectBuilder.getInstance().newAtom(Elements.HYDROGEN));
    	    mol.addAtom(a10);
    ...
    public static QueryAtomContainer alcoholSecondaryAttachedToTerminalVinyl() {
    	...
    	//return createQuery("[H]OC([H])(C)C([H])=C([H])[H]","secondary alcohol attached to terminal vinyl group");
    	  ...
    	  IAtom a1 = DefaultChemObjectBuilder.getInstance().newAtom(Elements.HYDROGEN);
    	  mol.addAtom(a1);
    	  IAtom a2 = DefaultChemObjectBuilder.getInstance().newAtom(Elements.OXYGEN);
    	  mol.addAtom(a2);
    	  IAtom a3 = DefaultChemObjectBuilder.getInstance().newAtom(Elements.CARBON);
    	  mol.addAtom(a3);
    	  IAtom a4 = DefaultChemObjectBuilder.getInstance().newAtom(Elements.HYDROGEN);
    	  mol.addAtom(a4);
    	  ...
    	  mol.addAtom(a6);
    	  IAtom a7 = DefaultChemObjectBuilder.getInstance().newAtom(Elements.HYDROGEN);
    	  mol.addAtom(a7);
    	  IAtom a8 = DefaultChemObjectBuilder.getInstance().newAtom(Elements.CARBON);
    	  mol.addAtom(a8);
    	  IAtom a9 = DefaultChemObjectBuilder.getInstance().newAtom(Elements.HYDROGEN);
    	  mol.addAtom(a9);
    	  IAtom a10 = DefaultChemObjectBuilder.getInstance().newAtom(Elements.HYDROGEN);
    	  mol.addAtom(a10);
    ...
    public static QueryAtomContainer esterOfalcoholSecondaryAttachedToTerminalVinyl() {
    	...
    	//return createQuery("CC(C(=O)OC)C=C","ester of secondary alcohol attached to terminal vinyl group");
    	  IMolecule mol = new org.openscience.cdk.Molecule();
    	  IAtom a1 = DefaultChemObjectBuilder.getInstance().newAtom(Elements.CARBON);
    	  mol.addAtom(a1);
    	  IAtom a2 = DefaultChemObjectBuilder.getInstance().newAtom(Elements.CARBON);
    	  mol.addAtom(a2);
    	  IAtom a3 = DefaultChemObjectBuilder.getInstance().newAtom(Elements.HYDROGEN);
    	  mol.addAtom(a3);
    	  IAtom a4 = DefaultChemObjectBuilder.getInstance().newAtom(Elements.HYDROGEN);
    	  mol.addAtom(a4);
    	  IAtom a5 = DefaultChemObjectBuilder.getInstance().newAtom(Elements.HYDROGEN);
    	  mol.addAtom(a5);
    	  IAtom a6 = DefaultChemObjectBuilder.getInstance().newAtom(Elements.CARBON);
    	  mol.addAtom(a6);
    	  ...
    	  mol.addAtom(a10);
    	  IAtom a11 = DefaultChemObjectBuilder.getInstance().newAtom(Elements.CARBON);
    	  mol.addAtom(a11);
    	  IAtom a12 = DefaultChemObjectBuilder.getInstance().newAtom(Elements.HYDROGEN);
    	  mol.addAtom(a12);
    ...
    public static IAtomContainer allylAlcohol() {
    	  ...
    	  IAtom a3 = DefaultChemObjectBuilder.getInstance().newAtom(Elements.CARBON);
    	  mol.addAtom(a3);
    	  IAtom a4 = DefaultChemObjectBuilder.getInstance().newAtom(Elements.OXYGEN);
    	  mol.addAtom(a4);
    	  IAtom a5 = DefaultChemObjectBuilder.getInstance().newAtom(Elements.HYDROGEN);
    	  mol.addAtom(a5);
    	  IAtom a6 = DefaultChemObjectBuilder.getInstance().newAtom(Elements.HYDROGEN);
    	  mol.addAtom(a6);
    	  IAtom a7 = DefaultChemObjectBuilder.getInstance().newAtom(Elements.HYDROGEN);
    	  mol.addAtom(a7);
    	  IAtom a8 = DefaultChemObjectBuilder.getInstance().newAtom(Elements.HYDROGEN);
    	  mol.addAtom(a8);
    	  IAtom a9 = DefaultChemObjectBuilder.getInstance().newAtom(Elements.HYDROGEN);
    	  mol.addAtom(a9);
    	  IAtom a10 = DefaultChemObjectBuilder.getInstance().newAtom(Elements.HYDROGEN);
    ...
    public static QueryAtomContainer allylAlcoholAcetal() {
    	...
    	//return createQuery("C(OCC=C)(OCC=C)[H]","allyl alcohol acetal");
    	  ...
    	  IAtom a5 = DefaultChemObjectBuilder.getInstance().newAtom(Elements.CARBON);
    	  mol.addAtom(a5);
    	  IAtom a6 = DefaultChemObjectBuilder.getInstance().newAtom(Elements.OXYGEN);
    	  mol.addAtom(a6);
    	  IAtom a7 = DefaultChemObjectBuilder.getInstance().newAtom(Elements.CARBON);
    	  mol.addAtom(a7);
    	  IAtom a8 = DefaultChemObjectBuilder.getInstance().newAtom(Elements.CARBON);
    	  mol.addAtom(a8);
    	  IAtom a9 = DefaultChemObjectBuilder.getInstance().newAtom(Elements.CARBON);
    	  mol.addAtom(a9);
    	  IAtom a10 = DefaultChemObjectBuilder.getInstance().newAtom(Elements.HYDROGEN);
    	  mol.addAtom(a10);
    	  IAtom a11 = DefaultChemObjectBuilder.getInstance().newAtom(Elements.CARBON);
    	  ...
    	  IAtom a12 = DefaultChemObjectBuilder.getInstance().newAtom(Elements.HYDROGEN);
    	  mol.addAtom(a12);
    	  IAtom a13 = DefaultChemObjectBuilder.getInstance().newAtom(Elements.HYDROGEN);
    	  mol.addAtom(a13);
    	  IAtom a14 = DefaultChemObjectBuilder.getInstance().newAtom(Elements.HYDROGEN);
    	  mol.addAtom(a14);
    	  IAtom a15 = DefaultChemObjectBuilder.getInstance().newAtom(Elements.HYDROGEN);
    	  mol.addAtom(a15);
    	  IAtom a16 = DefaultChemObjectBuilder.getInstance().newAtom(Elements.HYDROGEN);
    	  mol.addAtom(a16);
    	  IAtom a17 = DefaultChemObjectBuilder.getInstance().newAtom(Elements.HYDROGEN);
    	  mol.addAtom(a17);
    	  IAtom a18 = DefaultChemObjectBuilder.getInstance().newAtom(Elements.HYDROGEN);
    	  mol.addAtom(a18);
    	  IAtom a19 = DefaultChemObjectBuilder.getInstance().newAtom(Elements.HYDROGEN);
    	  mol.addAtom(a19);
    	  IAtom a20 = DefaultChemObjectBuilder.getInstance().newAtom(Elements.HYDROGEN);
    	  mol.addAtom(a20);
    	  IAtom a21 = DefaultChemObjectBuilder.getInstance().newAtom(Elements.HYDROGEN);
    	  mol.addAtom(a21);
    	  Bond b1 = new org.openscience.cdk.Bond(a2, a1, IBond.Order.SINGLE);
    	  mol.addBond(b1);
    	  Bond b2 = new org.openscience.cdk.Bond(a3, a2, IBond.Order.SINGLE);
    ...
    public static QueryAtomContainer allylAlcoholEsterDerivative() {
    	//TODO "CC=CCOC(=O)C[*]"
    	  ...
    	  IAtom a1 = DefaultChemObjectBuilder.getInstance().newAtom(Elements.OXYGEN);
    	  mol.addAtom(a1);
    	  IAtom a2 = DefaultChemObjectBuilder.getInstance().newAtom(Elements.CARBON);
    	  mol.addAtom(a2);
    	  IAtom a3 = DefaultChemObjectBuilder.getInstance().newAtom(Elements.CARBON);
    	  ...
    	  IAtom a9 = DefaultChemObjectBuilder.getInstance().newAtom(Elements.HYDROGEN);
    	  mol.addAtom(a9);
    	  IAtom a10 = DefaultChemObjectBuilder.getInstance().newAtom(Elements.CARBON);
    	  mol.addAtom(a10);
    	  IAtom a11 = DefaultChemObjectBuilder.getInstance().newAtom(Elements.HYDROGEN);
    	  mol.addAtom(a11);
    	  IAtom a12 = DefaultChemObjectBuilder.getInstance().newAtom(Elements.HYDROGEN);
    	  mol.addAtom(a12);
    	  Bond b1 = new org.openscience.cdk.Bond(a2, a1, IBond.Order.DOUBLE);
    ...
    public static IAtomContainer allylMercaptan() {
    	//return createAtomContainer("[H]SC([H])([H])C([H])=C([H])[H]","allyl mercaptan");
    	  ...
    	  IAtom a3 = DefaultChemObjectBuilder.getInstance().newAtom(Elements.CARBON);
    	  mol.addAtom(a3);
    	  IAtom a4 = DefaultChemObjectBuilder.getInstance().newAtom(Elements.SULFUR);
    	  mol.addAtom(a4);
    	  IAtom a5 = DefaultChemObjectBuilder.getInstance().newAtom(Elements.HYDROGEN);
    	  mol.addAtom(a5);
    	  IAtom a6 = DefaultChemObjectBuilder.getInstance().newAtom(Elements.HYDROGEN);
...
//    	return createAtomContainer("C=CCN","allyl amine");
    	  ...
    	  IAtom a3 = DefaultChemObjectBuilder.getInstance().newAtom(Elements.CARBON);
    	  mol.addAtom(a3);
    	  IAtom a4 = DefaultChemObjectBuilder.getInstance().newAtom(Elements.NITROGEN);
    	  mol.addAtom(a4);
    	  IAtom a5 = DefaultChemObjectBuilder.getInstance().newAtom(Elements.HYDROGEN);
    	  mol.addAtom(a5);
    	  IAtom a6 = DefaultChemObjectBuilder.getInstance().newAtom(Elements.HYDROGEN);
    ...
    public static IAtomContainer allylThioester() {
    	//	return createQuery("C(=O)SCC=C","allyl thioester");
    	  ...
    	  IAtom a2 = DefaultChemObjectBuilder.getInstance().newAtom(Elements.OXYGEN);
    	  mol.addAtom(a2);
    	  IAtom a3 = DefaultChemObjectBuilder.getInstance().newAtom(Elements.SULFUR);
    	  mol.addAtom(a3);
    	  IAtom a4 = DefaultChemObjectBuilder.getInstance().newAtom(Elements.CARBON);
    	  mol.addAtom(a4);
    	  IAtom a5 = DefaultChemObjectBuilder.getInstance().newAtom(Elements.CARBON);
    ...
    public static IAtomContainer methacrolein() {
    	//return createAtomContainer("C=C(C)C=O","methacrolein");
    	  ...
    	  IAtom a4 = DefaultChemObjectBuilder.getInstance().newAtom(Elements.CARBON);
    	  mol.addAtom(a4);
    	  IAtom a5 = DefaultChemObjectBuilder.getInstance().newAtom(Elements.OXYGEN);
    	  mol.addAtom(a5);
    	  IAtom a6 = DefaultChemObjectBuilder.getInstance().newAtom(Elements.HYDROGEN);
    	  mol.addAtom(a6);
    	  IAtom a7 = DefaultChemObjectBuilder.getInstance().newAtom(Elements.HYDROGEN);
    ...
    public static QueryAtomContainer stericallyHindered() {
		  ...
		  for (int i=0; i < 6; i++) {
		  	r[i] = new InverseSymbolSetQueryAtom();
			a[i] = new SymbolQueryAtom(DefaultChemObjectBuilder.getInstance().newAtom(Elements.CARBON));
			mol.addAtom(a[i]);
		  	r[i].addSymbol("H");
		  	mol.addAtom(r[i]);
		  	if (i>0) {
		  ...
		  SymbolQueryAtom a7 = new SymbolQueryAtom(DefaultChemObjectBuilder.getInstance().newAtom(Elements.CARBON));
    	  mol.addAtom(a7);
		  SymbolQueryAtom a11 = new SymbolQueryAtom(DefaultChemObjectBuilder.getInstance().newAtom(Elements.CARBON));
    	  mol.addAtom(a11);
			...
			for (int k=0; k<b.getAtomCount();k++) {
				...
				if (q.getID().equals(CARBOXYLIC_ACID_SALT))
					if (a1.getSymbol().equals("O") && (a1.getFormalCharge() != null) && (a1.getFormalCharge()==-1)) {
						...
						h = DefaultChemObjectBuilder.getInstance().newAtom(Elements.HYDROGEN);
						a.addAtom(h);
						...
						for (int ih=0;ih<neighbors.size();ih++) {
							...
							if (nh.getSymbol().equals("H")) {
								...
								if (cl.getSymbol().equals("Cl")) {
									...
									a.addBond(new org.openscience.cdk.Bond(cl,nh));
					...
					if (a1.getSymbol().equals("O")) {
						...
						h = DefaultChemObjectBuilder.getInstance().newAtom(Elements.HYDROGEN);
						a.addAtom(h);
						IAtom o = DefaultChemObjectBuilder.getInstance().newAtom(Elements.OXYGEN);
						a.addAtom(o);
					...
					if (apsp[f][g] > maxPathLength) {
						try {
							...
							if (PathTools.depthFirstTargetSearch(
									(org.openscience.cdk.AtomContainer)mol,
									(org.openscience.cdk.Atom)mol.getAtom(f),
									(org.openscience.cdk.Atom)mol.getAtom(g),path)) {
