...
public class RuleMolWeight extends RuleVerifyProperty {
	...
	public IMolecule getExampleMolecule(boolean ruleResult) throws DecisionMethodException {
        ...
        if (ruleResult){
        		...
        		m = (IMolecule)FunctionalGroups.createAtomContainer("OS(=O)(=O)c1cc2NC4(Nc2c(c1)S(O)(=O)=O)C=3\\C=C/C4=C\\C=3",true);
    			m.setProperty(MolWeight, 674.567985);
        }
    	else {
    		m = (IMolecule)FunctionalGroups.createAtomContainer("S(SCCC)CCC",true);
