...
public class SA28Test extends TestMutantRules {
    ...
    public void test_SO3H_rule() throws Exception {
        ...
        //exclusionRuleTest(SA28.index_so3h_4);
    }       
    public void exclusionRuleTest(int index) throws Exception {
        ...
        assertEquals(((Boolean)SA28.exclusion_rules[index][4]).booleanValue()
                ,verifyRule(ruleToTest,SA28.exclusion_rules[index][2].toString()));
    }        
}
