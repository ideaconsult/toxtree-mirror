...
public class ShellMengine extends ShellSDFoutput<IMolecule> {
	...
	protected void initialize() throws ShellException {
        ...
        */
        addExecutable(CommandShell.os_WINDOWS, Preferences.getProperty(Preferences.MENGINE_WIN));        
        addExecutable(CommandShell.os_LINUX, Preferences.getProperty(Preferences.MENGINE_LINUX));        
