...
public class ShellSmi2SDF extends ShellSDFoutput<IMolecule> implements PropertyChangeListener {
	...
	protected void initialize() throws ShellException {
        ...
        */
        addExecutable(CommandShell.os_WINDOWS, Preferences.getProperty(Preferences.SMI2SDF_WIN));        
        addExecutable(CommandShell.os_LINUX, Preferences.getProperty(Preferences.SMI2SDF_LINUX));            
