...
public class OpenBabelShell extends ShellSDFoutput<String>implements PropertyChangeListener {
	...
	protected void initialize() throws ShellException {
        ...
        addExecutable(CommandShell.os_WINDOWS, Preferences.getProperty(Preferences.OPENBABEL_WIN));        
        addExecutable(CommandShell.os_LINUX, Preferences.getProperty(Preferences.OPENBABEL_LINUX));           
