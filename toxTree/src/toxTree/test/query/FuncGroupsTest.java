...
public class FuncGroupsTest extends TestCase {
    ...
    public void testmatchInherited() throws Exception {
        ...
        SymbolAndChargeQueryAtom c2 = new SymbolAndChargeQueryAtom(DefaultChemObjectBuilder.getInstance().newAtom(Elements.CARBON));
    ...
    public void sulphateOfAmine() {
    	IAtomContainer c = TestCasesFactory.phenazineMethosulphate();
...
//        FunctionalGroups.markMaps(mol,q1,list);
	...
	protected IMolecule salt() {
	    ...
	    mol.addAtom(a4);
	    IAtom a5 = DefaultChemObjectBuilder.getInstance().newAtom(Elements.NITROGEN);
	    mol.addAtom(a5);
	    ...
	    mol.addAtom(a7);
	    IAtom a8 = DefaultChemObjectBuilder.getInstance().newAtom(Elements.CHLORINE);
	    mol.addAtom(a8);
