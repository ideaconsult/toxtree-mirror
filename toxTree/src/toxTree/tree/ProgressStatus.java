...
//	0 not estimated, 1 estimating; 2 estimated ; 3 : unknown ; 4 : error
	...
	public void setEstimated(boolean value) {
        if (value) estimated = STATUS.COMPLETED; else estimated = STATUS.NOTESTIMATED;
	}
	...
	public String toString() {
        switch (estimated) {
        case NOTESTIMATED: return _eResultNotEstimated;
        case INPROGRESS: return _eResultIsEstimating;
        case COMPLETED: return "Completed ";
        case ERROR: return "Error\t"+ getErrMessage();        
        default: return _eUnknownState;
        }
	}
}
